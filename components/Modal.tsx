            ...
            <div className='space-y-6 text-lg'>
                ...
                <div className='flex flex-col gap-x-10 gap-y-4 font-light md:flex-row'>
                    ...
                    <div className='flex flex-col space-y-3 text-sm'>
                        <div><span className='text-[gray]'>Genres: </span> {genres.map((genre)=>genre.name).join(', ')}</div>
                        <div><span className='text-[gray]'>Original language: </span>{movie?.original_language}</div>
